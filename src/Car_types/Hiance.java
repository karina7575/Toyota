...
public class Hiance extends Car {
    ...
    public Hiance(String color, int maxSpeed, Wheel[] wheels, GasTank gasTank, Engine engine, Electrics electrics, Headlights headlights, int diameterSpareWheel, int liftingCapacity) {
